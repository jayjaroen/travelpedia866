...
ActiveRecord::Schema.define(version: 2022_06_26_072324) do
  ...
  create_table "booking_requests", force: :cascade do |t|
    ...
    t.index ["itinerary_id"], name: "index_booking_requests_on_itinerary_id"
  ...
  add_foreign_key "booking_requests", "itineraries"
